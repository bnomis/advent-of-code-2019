(ns aoc.test
  (:require [clojure.test :refer [deftest testing is]]
            ...
            [aoc.day05.core :refer [run-program] :rename {run-program rp5}]))
...
(deftest day-05-part-1
  (testing "run-program"
    (is (= [3500,9,10,70,2,3,11,0,99,30,40,50] (rp5 [1,9,10,3,2,3,11,0,99,30,40,50])))
    (is (= [2,0,0,0,99] (rp5 [1,0,0,0,99])))
    (is (= [2,3,0,6,99] (rp5 [2,3,0,3,99])))
    (is (= [2,4,4,5,99,9801] (rp5 [2,4,4,5,99,0])))
    (is (= [30,1,1,4,2,5,6,0,99] (rp5 [1,1,1,4,99,5,6,0,99])))))
